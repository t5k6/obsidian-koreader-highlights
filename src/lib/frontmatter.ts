...
export function parseFrontmatter(
  ...
  try {
    ...
    const hash = frontmatter && typeof frontmatter.sha256 === "string" ? frontmatter.sha256 : null;
 ...
 */
export function composeFrontmatter(fields: Record<string, unknown>, body: string): string {
