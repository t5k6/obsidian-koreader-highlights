...
import { compareAnnotations, getHighlightKey } from "src/lib/formatting/formatUtils";
...
export function performDiff3(ours: string, base: string, theirs: string): MergeRegion<string>[] {
