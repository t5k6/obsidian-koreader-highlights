...
import type { DuplicateMatch, KoreaderHighlightImporterSettings } from "src/types";
import { formatConflictRegions, performDiff3 } from "./diffCore";

export type MergeStrategy = "auto-merge" | "prompt-user" | "direct-replace" | "direct-merge";
...
export function createMergeContext(
  ...
  return {
    analysis,
    settings,
    isUpdateOnly: analysis.matchType === "updated" && analysis.modifiedHighlights === 0,
