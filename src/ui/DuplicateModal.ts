...
import { createApplyToAllToggle, ModalContentBuilder } from "src/ui/utils/modalComponents";
import type {
  DuplicateChoice,
  ...
  implements IDuplicateHandlingModal
{
  ...
  protected renderContent(contentEl: HTMLElement): void {
    ...
    let mergeTooltip = "Performs a 3-way merge, combining your local edits with new highlights.";
    if (isExactMatch) mergeTooltip = "Merge is disabled because the content is identical.";
