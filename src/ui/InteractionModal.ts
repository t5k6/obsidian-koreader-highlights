...
type InteractionModalResult<C extends InteractionModalConfig> = C["mode"] extends "confirm"
  ? boolean
 ...
 */
export class InteractionModal<C extends InteractionModalConfig> extends BaseModal<
  InteractionModalResult<C>
> {
  ...
  private constructor(
    ...
    this.value = this.options.mode === "prompt" ? (this.options.defaultValue ?? "") : "";
  }
  ...
  private submitPrompt(): void {
    ...
    this.resolveAndClose((trimmed ? trimmed : null) as InteractionModalResult<C>);
  }
}
