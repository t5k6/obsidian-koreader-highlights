...
export class SettingsTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    this.sections = [
      new CoreSettingsSection(this.koreaderPlugin, this.debouncedSave, "Core Settings", true),
      new ImportActionsSection(this.koreaderPlugin, this.debouncedSave, "Import Actions", true),
