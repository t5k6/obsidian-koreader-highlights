...
const domTestIncludes = ["**/ui/**/*.test.ts"];
...
export default defineConfig({
  test: {
    ...
    coverage: {
      ...
      exclude: ["node_modules/**", "tests/**", "**/*.test.*", "dist/**", "build/**"],
    },
    ...
    projects: [
      ...
      mergeConfig(shared, {
        test: {
          ...
          // ...BUT explicitly exclude the files that were already handled by the 'dom' project.
          // This prevents tests from running twice and ensures clean separation.
          exclude: domTestIncludes,
        },
      }),
    ],
  },
